...
#The makefile tells the make program which files are dependent on which other files. 
#I added ps under UPROGS (which is typically refers to a list of user-space programs (utilities or commands) that need to be compiled and included in the final system image.) 
